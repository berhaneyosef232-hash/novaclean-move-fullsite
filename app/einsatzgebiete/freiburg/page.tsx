...
export const metadata: Metadata = {
  title: "Umzug & Reinigung Freiburg/Fribourg | NovaClean & Move",
  description:
    "NovaClean & Move für Umzug, Endreinigung, Unterhaltsreinigung und Entsorgung in Freiburg/Fribourg und Umgebung. Jetzt kostenlose Offerte anfragen.",
};
      ...
      <section className="bg-black text-white">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
          <p className="mb-4 font-semibold uppercase tracking-[0.2em] text-amber-400">
            Freiburg/Fribourg & Umgebung
          </p>

          <h1 className="max-w-4xl text-4xl font-bold tracking-tight md:text-6xl">
            Umzug & Reinigung in Freiburg/Fribourg
          </h1>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-gray-300">
            ...
            in Freiburg/Fribourg und Umgebung.
          </p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <h2 className="text-3xl font-bold text-black md:text-4xl">
            Unsere Dienstleistungen in Freiburg/Fribourg
          </h2>

          <p className="mt-4 max-w-3xl leading-7 text-gray-600">
            Vom Wohnungswechsel bis zur Wohnungsabgabe unterstützen wir Sie
            zuverlässig und persönlich bei Ihrem Auftrag.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <Service
              ...
              text="Wir unterstützen bei Räumungen und transportieren nicht mehr benötigte Gegenstände zur Entsorgung."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <p className="font-semibold text-amber-600">
            Ihr Ansprechpartner in Freiburg/Fribourg & Umgebung
          </p>
          ...
          <p className="mt-4 max-w-3xl leading-7 text-gray-600">
            ...
            Freiburg/Fribourg und Umgebung können Sie mich direkt kontaktieren.
          </p>
      ...
      <section className="bg-black text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 text-center">
          <h2 className="text-3xl font-bold">
            Umzug oder Reinigung in Freiburg/Fribourg geplant?
          </h2>
