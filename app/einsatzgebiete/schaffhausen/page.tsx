...
export const metadata: Metadata = {
  title: "Umzug & Reinigung Schaffhausen | NovaClean & Move",
  description:
    "NovaClean & Move für Umzug, Endreinigung, Unterhaltsreinigung und Entsorgung in Schaffhausen und Umgebung. Jetzt kostenlose Offerte anfragen.",
};

export default function SchaffhausenPage() {
  return (
    <main>
      <section className="bg-black text-white">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
          ...
          <h1 className="max-w-4xl text-4xl font-bold tracking-tight md:text-6xl">
            Umzug & Reinigung in Schaffhausen
          </h1>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <h2 className="text-3xl font-bold text-black md:text-4xl">
            Unsere Dienstleistungen in Schaffhausen
          </h2>

          <p className="mt-4 max-w-3xl leading-7 text-gray-600">
            Von Ihrem Umzug bis zur Wohnungsabgabe unterstützen wir Sie
            zuverlässig bei den anfallenden Arbeiten.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <Service
              ...
              text="Wir unterstützen bei Räumungen und beim Transport nicht mehr benötigter Gegenstände zur Entsorgung."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <p className="font-semibold text-amber-600">
            Ihr Ansprechpartner in Schaffhausen & Umgebung
          </p>
          ...
          <p className="mt-4 max-w-3xl leading-7 text-gray-600">
            ...
            Schaffhausen und Umgebung können Sie uns direkt kontaktieren.
          </p>
      ...
      <section className="bg-black text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 text-center">
          <h2 className="text-3xl font-bold">
            Umzug oder Reinigung in Schaffhausen geplant?
          </h2>
